...
function replaceBase(doc, section) {
  var base;
  var head;
  var url = section.baseUrl + section.url;
...
var rendition_Rendition = /*#__PURE__*/function () {
  ...
  rendition_createClass(Rendition, [{
    ...
    value: function _display(target) {
      ...
      if (this.settings.baseUrl && !section.baseUrl) {
        section.baseUrl = this.settings.baseUrl;
      }
    ...
    */
    ...
    value: function adjustImages(contents) {
      ...
      var height = (contents.content.offsetHeight - (parseFloat(computed.paddingTop) + parseFloat(computed.paddingBottom))) * 0.95;
